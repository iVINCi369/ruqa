...
// Канал обновлений AlterSend выброшен при ребрендинге, своего OTA у Ruqa нет.
...
// Пока она там, OTA принудительно выключены: иначе апдейтер будет бесконечно
// искать в сети то, чего не существует. Про новые версии пользователю сообщает
// renderer — useUpdateCheck спрашивает последний релиз в репозитории и ведёт на
// страницу загрузки; заменять этот блок нужно только вместе со своим каналом.
